...
import { Heart, X, Settings, User, LayoutDashboard, Users, MessageCircle, QrCode, Printer, LogOut, Menu } from 'lucide-react';
...
const Sidebar = ({ invitationId, userName, initialTab }) => {
  ...
  const manageItems = invitationId ? [
    { id: "overview", label: "Kelola Undangan", icon: LayoutDashboard },
