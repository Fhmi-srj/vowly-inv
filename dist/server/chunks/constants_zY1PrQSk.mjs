...
const GALLERY_IMAGES = parseJson(undefined                                     , [
  "https://placehold.co/450x800",
  "https://placehold.co/450x800"
]);

export { BANK_ACCOUNTS as B, GALLERY_IMAGES as G, LOVE_STORY as L, MAX_GUESTS as M, WEDDING_CONFIG as W, WEDDING_TEXT as a, MUSIC_URL as b };
