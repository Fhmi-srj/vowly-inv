...
import { W as WEDDING_CONFIG } from '../chunks/constants_DNnL6zYp.mjs';
...
</p> </div> <div class="rounded-3xl border border-slate-100 bg-white p-8 shadow-xl dark:border-white/5 dark:bg-slate-800"> ${renderComponent($$result2, "QRCodeGenerator", QRCodeGenerator, { "client:load": true, "siteUrl": Astro2.site?.toString() || "https://wedding.feyaya.com", "client:component-hydration": "load", "client:component-path": "C:/laragon/www/Undangan-Pernikahan/src/themes/Shared/QRCodeGenerator", "client:component-export": "default" })} </div> <div class="text-center"> <a href="/admin" class="text-sm font-bold tracking-widest text-slate-400 uppercase hover:text-slate-600">
&larr; Kembali ke Dashboard
</a> </div> </div> </div> ` })}`;
}, "C:/laragon/www/Undangan-Pernikahan/src/pages/qrcode.astro", void 0);

const $$file = "C:/laragon/www/Undangan-Pernikahan/src/pages/qrcode.astro";
const $$url = "/qrcode";
